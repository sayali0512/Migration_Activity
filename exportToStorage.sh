...
echo source_db_server_name=$9  #mysql-5nw26r.mysql.database.azure.com
echo source_db_login_name=$10  #dbadmin@mysql-5nw26r
echo source_db_pass=$11 #db password
echo source_db_name=$12  # wordpress
echo sql_dump_filename=$13  #database.sql
echo wp_path=$14   # /azlamp/html
echo wp_data_path=$15    # /azlamp/data
