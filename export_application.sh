...
blob_storage=$6/$4.tar  # blob file name /vmname/
...
create_container(){
    ...
    az storage container create --account-name $storage_name --name $container_name/$source_dns_name --sas-token $SAS_token
}
